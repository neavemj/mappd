...
```{r testing_table_links}  

sample <- c("samp1", "samp2", "samp3")
link <- c("[l1](https://www.rstudio.com)", "[clnk](04_annotation/diamond/sRRV_contigs_taxid/11029.fasta)", "[clnk](04_annotation/diamond/sRRV_contigs_taxid/9597.fasta)")

df <- data.frame(sample, link)

kbl(df)

dummy <- read.csv("/datasets/work/aahl-pdngs/work/test_data/evag2/2.mappd/dummy_links.txt", sep="\t", header=T)
...
```{r per_sample, fig.width=8, fig.height=ht, warning=FALSE}
